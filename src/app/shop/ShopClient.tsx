...
function ShopClient() {
  ...
  const getData = async () => {
    try {
      const res = await axios.get("https://realalisaberi.ir/products");
  ...
  const getCats = async () => {
    try {
      const cat_res = await axios.get('https://realalisaberi.ir/categories');
  ...
  const getCatProducts = async (id: number) => {
    try {
      const cat_products = await axios.get(`https://realalisaberi.ir/products/category/${id}`);
